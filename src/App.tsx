        ...
        <>
            ...
            <div className="regarding-container" id="regarding-literature" onMouseMove={handleLiteratureMouseMove}>
                ...
                <div className={`regarding-chinese ${literatureShifted ? 'visible' : ''}`}>
                    <div className="text-wrapper">
                        <h1>关于文学</h1>
                        <p>我13岁开始写中国古典的格律诗，边写边读，最爱《诗经》乐府辛弃疾。诗作偶有发表。高中开始学哲学，但先广泛涉猎政治经济与历史，而后才从斯通普夫厚厚的《西方哲学史》开始，一直学到拉康精神分析。前人的气概对我影响颇深。到大学之后，散文创作不再受桎梏，躬行"文无定格，贵在鲜活"之道。灵光乍现的时候，也曾得过同济的第一。诗歌、哲学、散文，现在都不读了。现在学习小说。</p>
                    </div>
                </div>
            </div>
            ...
            <div className="regarding-container reverse" id="regarding-design" onMouseMove={handleDesignMouseMove}>
                ...
                <div className={`regarding-chinese ${designShifted ? 'visible' : ''}`}>
                    <div className="text-wrapper">
                        <h1>关于设计</h1>
                        <p>鄙人无音韵之天赋，亦无美术之基础，设计一途，只能靠多想多做。平面设计，海报做了不少，大都普普通通，好在曾为几场国际会议做过主视觉。视屏剪辑，学艺不精，要做动画，恐怕效率难以差强人意。设计思维，符号与能指，幸亏有些哲学基础，可供我夸夸其谈。游戏设计尚在学习中，大可期待一番。至于前端网页设计——可交互的海报，由你控制的动画——我所做的，就在你眼前了。</p>
                    </div>
                </div>
            </div>
            ...
            <div className="regarding-container" id="regarding-ai" onMouseMove={handleAiMouseMove}>
                ...
                <div className={`regarding-chinese ${aiShifted ? 'visible' : ''}`}>
                    <div className="text-wrapper">
                        <h1>关于人工智能</h1>
                        <p>微积分、线性代数、概率论，都是最开始掌握的基础。离散数学、信号与系统、最优化理论，都是深入其中必须借助的工具。再加上计算机科学与编程语言，就可以进入机器学习的世界。再结合矩阵乘法与非仿射函数，就可以搭建起人工神经网络。借助梯度提升决策树与多层感知机，我也在国内国外各比赛、平台拿过一些奖。如今在涉猎时序分析、量化金融与区块链。更深入的学习，就交给未来了。</p>
                    </div>
                </div>
            </div>
        </>
